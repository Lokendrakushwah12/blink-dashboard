...
const CitiesUserTable = () => {
  ...
  const filteredUsers = React.useMemo(() => {
    return countryData.users.filter((user) => {
  ...
  return (
    <div className="mx-auto w-full space-y-6 px-4">
      ...
      {/* <CardTitle>Users in {countryData.name}</CardTitle> */}
      ...
      <Card>
        <CardHeader>
          <CardTitle>Users in {countryData.name}</CardTitle>
          <CardDescription>
            Showing {filteredUsers.length} of {countryData.users.length} total
            users
          </CardDescription>
